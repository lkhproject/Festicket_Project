...
public interface IDao {
	...
	// 아이디/비밀번호 찾기
	public String findId_result(String name, String userPhone); // 아이디 찾기
	public String findPw_result(String userId, String email, String userPhone); // 비밀번호 찾기
	...
	public int getTotalTicketDao(int eventNum); // 행사 남은 티켓 수
	...
	public List<EventReviewLikeDto> getLikedReviewList(String userId, String eventNum); // 리뷰 좋아요 리스트 가져오기

	// 예약
	public List<ReserveDto> getReservationListDao(String userId, int countList, int pageNum); // 예약 리스트 최신순으로 가져오기
