...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/reviewView.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/ratingStar_view.css">
...
<body>
	...
	<div class="container">
		...
		<h2 class="rvWriteTitle">나의 후기</h2>
			<!-- 별점 기능 -->
