		...
		<ul class="pagination">
			<li class="page-item" id="page-item">
				<c:if test="${pageMaker.prev }">
					<a class="page-link" href="searchOrderBy?keyword=${search_word }&orderOption=${param.orderOption}&pageNum=${pageMaker.startPage-5 }">
			...
			<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
				<c:choose>
					...
					<c:otherwise>
						<li class="page-item">
							<a class="page-link" href="searchOrderBy?keyword=${search_word }&orderOption=${param.orderOption}&pageNum=${num }">${num }</a>
						</li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
