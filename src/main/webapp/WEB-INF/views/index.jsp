                ...
                <c:forEach items="${festival_5 }" var="festival" begin="0" end="4">
                    <div class="col" style="float: none; margin 0 auto">
                        ...
                        <div class="card" id="cardList">
                            <img src="${festival.main_img }" class="card-img-top" id="card_img" onclick="script:window.location.href='rvView?selectedEvent=${festival.eventNum }'"><!-- 상세페이지로 이동 -->
                            <div class="card-body">
                                <h5 class="card-title">
                                    <c:choose>
                                        <c:when test="${fn:length(festival.title) > 14}">
                                            <c:out value="${fn:substring(festival.title, 0, 13)}"></c:out>...
                                        </c:when>
                                        <c:otherwise>
                ...
                <c:forEach items="${exhibition_5 }" var="exhibition" begin="0" end="4">
                    <div class="col" style="float: none; margin 0 auto">
                        <div class="card" id="cardList">
                            ...
                            <img src="${exhibition.main_img }" class="card-img-top" id="card_img" onclick="script:window.location.href='rvView?selectedEvent=${exhibition.eventNum }'"><!-- 상세페이지로 이동 -->
                            <div class="card-body">
                                <h5 class="card-title">
                                    <c:choose>
                                        <c:when test="${fn:length(exhibition.title) > 14}">
                                            <c:out value="${fn:substring(exhibition.title, 0, 13)}"></c:out>...
                                        </c:when>
                                        <c:otherwise>
