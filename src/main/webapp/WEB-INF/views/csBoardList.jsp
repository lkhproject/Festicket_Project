...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/csBoardList.css">
                    ...
                    <tbody class="table-group-divider">
                        <c:forEach items="${CSboardDtos }" var="csList" begin="0" end="11">
                            <tr>
                                ...
                                <td><a href="csBoardView?c_idx=${csList.c_idx }"> <!-- 제목 글자수 제한 -->
                                        <c:choose>
                    ...
                    <ul class="pagination">
                        <li class="page-item" id="page-item">
                            <c:if test="${pageMaker.prev }">
                                <a class="page-link" aria-label="Previous" href="csBoardList?pageNum=${pageMaker.startPage-5 }"> <span aria-hidden="true">&laquo;</span>
                                </a>
                            </c:if>
                        </li>
                        ...
                        <c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="num">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item"><a class="page-link" href="csBoardList?pageNum=${num }">${num }</a></li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        ...
                        <li class="page-item">
                            <c:if test="${pageMaker.next }">
                                <a class="page-link" aria-label="Next" href="csBoardList?pageNum=${pageMaker.startPage+5 }"> <span aria-hidden="true">&raquo;</span>
                                </a>
                            </c:if>
                        </li>
                    </ul>
